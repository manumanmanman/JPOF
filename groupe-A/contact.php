...
<div class="container">
    <div class="event">
        <div class="row">
            <div class="col-12 col-md-4 google-maps">
            ...
            <div class="col-12 col-md-8 contact">
                <h1>Contact</h1>
                        <div>
                        <h4>Vous pouvez nous contacter par mail : <a href="#">JPOF@mail.com</a></h4>
                        <h4>Vous pouvez nous contacter par téléphone : <a href="#">0465235689</a></h4>
                        <h4>Notre adresse disponble pour courriel : <a href="#">4 rue de midi, 1000 Bruxelles</a></h4>
                        </div>
