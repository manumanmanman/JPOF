...
<div class="container-xl activitees">
...
foreach ($activities as $activity) {    // Début de la boucle
    ...
    ?>
            <div id="id_<?php echo $activityid ; ?>" class="col-lg-4 card-complet <?php echo $activity["category_slug"]; ?>">
