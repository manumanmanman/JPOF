...
echo ' <a class="remove" href="#" data-activity="'.$activity_id.'"><svg width="1.5em" height="1.5em" viewBox="0 0 16 16" class="bi bi-heart-fill" fill="red" xmlns="http://www.w3.org/2000/svg">
