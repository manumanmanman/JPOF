...
?>
<div id="details-activity" class="container-lg">
    <div class="row m-1 ">
...
<h1 class="text-center mb-4 pb-2 text-dark border border-top-0 border-right-0 border-left-0"><?php echo ($activity["activity_name"]); ?> <?php //echo $activity["activity_id"]; ?></h1>
</div>
<div class="col-12 col-md-6 border border-white py-3 rounded-left">
...
<div class="col-12 col-md-6 bg-white rounded-right py-3">
...
<div class="col-12  rounded bg-light p-4 my-4" >
